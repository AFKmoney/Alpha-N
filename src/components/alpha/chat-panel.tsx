...
// ---------------------------------------------------------------------------
// Minimal Web Speech API types — lib.dom.d.ts does not always expose
// webkitSpeechRecognition, so we declare the surface we use here. This keeps
// the component fully typed (zero `any`) while staying compatible with
// Chromium-based browsers that implement the spec.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
type PersonalityKey = "architect" | "hacker" | "mentor" | "rogue";
...
const DEFAULT_PERSONALITY: PersonalityKey = "architect";

function getPersonality(key: PersonalityKey): PersonalityProfile {
...
const TEXT_EXTENSIONS = ["txt", "md", "json", "ts", "tsx", "js", "jsx", "py"];
...
const LS_PERSONALITY = "alpha-n:chat-personality";
const LS_TTS = "alpha-n:chat-tts";
const LS_PINS = "alpha-n:chat-pins";
